...
from core.views import HomeView, ProfileView, StandDetailView, ReservaDetailView
from reserva.views import ReservaCreateView,ReservaDeleteView,ReservasListView,ReservaUpdateView
